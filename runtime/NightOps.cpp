...
#include "runtime/NightOpcodeVersion.h"
#include "vm/Opcodes.h"

static_assert(JSOP_SEMANTICS_VERSION == NIGHT_JSOP_SEMANTICS_VERSION,
              "SpiderMonkey bytecode semantics changed: review the lowerings "
              "against vm/Opcodes.h, then raise NIGHT_JSOP_SEMANTICS_VERSION");
